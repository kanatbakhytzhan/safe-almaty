...
function generateMountainShelters() {
  const shelters = [
    {
      name: 'Medeu High-Mountain Rink',
      nameKz: 'Медеу жоғары таулы мұз айдыны',
    ...
    },
    {
      ...
      nameKz: 'Шымбұлақ шаңғы курорты',
      nameRu: 'Горнолыжный курорт Шымбулак',
    ...
    {
      name: 'Kok Tobe Hill',
      nameKz: 'Көк Төбе төбесі',
      nameRu: 'Холм Кок Тобе',
